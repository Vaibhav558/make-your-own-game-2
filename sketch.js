...
function setup() {
  ...
  wall7= createSprite(10,20,100,10);
...
function draw() {
  ...
  if (gameState === 0){
    ...
    {hero.x=hero.x-2}; if(hero.isTouching(wall1)|| hero.isTouching(wall2)||  hero.isTouching(wall3)||  hero.isTouching(wall4 )||  hero.isTouching(wall5) || hero.isTouching(wall6)|| hero.isTouching(wall7)
